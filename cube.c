...
#define CUBESIZ	100		/* cube size*/
#define CUBEWID	100		/* cube size*/
#define CUBEHIH	100		/* cube size*/

/* vertex */
static SVECTOR P0 = {-CUBEHIH/2,-CUBEWID/2,-CUBESIZ/2,0};
static SVECTOR P1 = { CUBEHIH/2,-CUBEWID/2,-CUBESIZ/2,0};
static SVECTOR P2 = { CUBEHIH/2, CUBEWID/2,-CUBESIZ/2,0};
static SVECTOR P3 = {-CUBEHIH/2, CUBEWID/2,-CUBESIZ/2,0};

static SVECTOR P4 = {-CUBEHIH/2,-CUBEWID/2, CUBESIZ/2,0};
static SVECTOR P5 = { CUBEHIH/2,-CUBEWID/2, CUBESIZ/2,0};
static SVECTOR P6 = { CUBEHIH/2, CUBEWID/2, CUBESIZ/2,0};
static SVECTOR P7 = {-CUBEHIH/2, CUBEWID/2, CUBESIZ/2,0};
...
/*	POLY_F4 box */
void add_boxF4(int h, int w, int l,u_long *ot, POLY_F4 *s, MATRIX *rottrans)
{
	int	i;
	long	p, otz, opz, flg;
	int	isomote;
